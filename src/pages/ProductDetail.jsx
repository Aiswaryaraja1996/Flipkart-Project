  ...
  return (
    <div style={{ backgroundColor: "#f1f3f6" }}>
      ...
      >
        <Grid
          container
          sx={{ backgroundColor: "#FFFFFF", padding: "16px 16px 16px 16px" }}
        >
          <Grid item xs={5}>
            <Box
              sx={{
          ...
          >
            ...
            >
              {product.title}
              <Typography
                sx={{ color: "black", fontSize: "18px", marginTop: "3px" }}
              >
                {product.shortTitle}
              </Typography>
            </h1>
            ...
            <Typography sx={{ marginLeft: "24px" }}>
              ...
              &nbsp;&nbsp;&nbsp;
              <span
                style={{ color: "#26a541", fontWeight: 500, fontSize: "16px" }}
              >
            ...
            <Typography
              sx={{ color: "#878787", fontSize: "14px", marginLeft: "24px" }}
              style={{
                marginTop: 5,
                display: "flex",
                flexDirection: "row",
            ...
            <Stack direction="column" sx={{ marginTop: "10px" }}>
              ...
              <div
                style={{ lineHeight: 1.43, color: "#212121", fontSize: "14px" }}
              >
                <span style={{ marginTop: "12px", display: "flex" }}>
                  ...
                  <li style={{ listStyle: "none", display: "flex" }}>
                    ...
                    <span>Get extra 20% off (price inclusive of discount)</span>
                    <div
                      style={{
                        color: "#2874f0",
                        fontWeight: 500,
